...
class WinGUI(Tk):
    ...
    def __init__(self):
        ...
        self.widget_dic["tk_text_lhbny85f"].insert(
            END, self.calculator.get_res_table())
    ...
    def __tk_tabs_lhbmo7q9(self, parent):
        ...
        self.widget_dic["tk_tabs_lhbmo7q9_0"] = self.__tk_frame_lhbmo7q9_0(
            frame)
        frame.add(self.widget_dic["tk_tabs_lhbmo7q9_0"], text="分压")

        self.widget_dic["tk_tabs_lhbmo7q9_1"] = self.__tk_frame_lhbmo7q9_1(
            frame)
        frame.add(self.widget_dic["tk_tabs_lhbmo7q9_1"], text="凑电阻")

        self.widget_dic["tk_tabs_lhbmo7q9_2"] = self.__tk_frame_lhbmo7q9_2(
            frame)
    ...
    def __tk_frame_lhbmo7q9_0(self, parent):
        ...
        self.widget_dic["tk_label_frame_lhbmohd8"] = self.__tk_label_frame_lhbmohd8(
            frame)
        ...
        self.widget_dic["tk_button_lhbn5n3b"] = self.__tk_button_lhbn5n3b(
            frame)
    ...
    def __tk_frame_lhbmo7q9_1(self, parent):
        ...
        self.widget_dic["tk_label_frame_lhbn9t2y"] = self.__tk_label_frame_lhbn9t2y(
            frame)
        ...
        self.widget_dic["tk_button_lhbnf1zk"] = self.__tk_button_lhbnf1zk(
            frame)
        return frame
    ...
    def __tk_frame_lhbmo7q9_2(self, parent):
        ...
        self.widget_dic["tk_label_frame_lhbnuzvr"] = self.__tk_label_frame_lhbnuzvr(
            frame)
        self.widget_dic["tk_label_frame_lhbnxq01"] = self.__tk_label_frame_lhbnxq01(
            frame)
        return frame
    ...
    def __tk_label_frame_lhbmohd8(self, parent):
        ...
        self.widget_dic["tk_radio_button_lhbmrg3d"] = self.__tk_radio_button_lhbmrg3d(
            frame)
        self.widget_dic["tk_radio_button_lhbmrjiz"] = self.__tk_radio_button_lhbmrjiz(
            frame)
        return frame

    def __tk_radio_button_lhbmrg3d(self, parent):
        rb = Radiobutton(parent, text="降压",
                         variable=self.divider_type, value=1)
        rb.place(x=10, y=0, width=80, height=25)
        return rb

    def __tk_radio_button_lhbmrjiz(self, parent):
        rb = Radiobutton(parent, text="升压",
                         variable=self.divider_type, value=2)
    ...
    def __tk_label_frame_lhbn9t2y(self, parent):
        ...
        self.widget_dic["tk_radio_button_lhbn9vxx"] = self.__tk_radio_button_lhbn9vxx(
            frame)
        self.widget_dic["tk_radio_button_lhbn9xmo"] = self.__tk_radio_button_lhbn9xmo(
            frame)
        self.widget_dic["tk_radio_button_lhbn9z6i"] = self.__tk_radio_button_lhbn9z6i(
            frame)
        return frame

    def __tk_radio_button_lhbn9vxx(self, parent):
        rb = Radiobutton(parent, text="R1+R2",
                         variable=self.res_compose_type, value=1)
        rb.place(x=10, y=10, width=80, height=30)
        return rb

    def __tk_radio_button_lhbn9xmo(self, parent):
        rb = Radiobutton(parent, text="R1//R2+R3",
                         variable=self.res_compose_type, value=3)
        rb.place(x=170, y=10, width=112, height=30)
        return rb

    def __tk_radio_button_lhbn9z6i(self, parent):
        rb = Radiobutton(parent, text="R1//R2",
                         variable=self.res_compose_type, value=2)
    ...
    def __tk_label_frame_lhbnuzvr(self, parent):
        ...
        self.widget_dic["tk_button_lhbnwwer"] = self.__tk_button_lhbnwwer(
            frame)
...
class Win(WinGUI):
    ...
    def handle_divider_cal(self, evt):
        ...
        self.calculator.voltage_divider_cal(
            vin, vout, cal_type, r1_min, r1_max, r2_min, r2_max)
    ...
    def handle_res_import(self, evt):
        res_text = self.widget_dic["tk_text_lhbnzn1i"].get(
            "1.0", END).split(",")
    ...
    def __event_bind(self):
        self.widget_dic["tk_button_lhbn5n3b"].bind(
            '<Button-1>', self.handle_divider_cal)
        self.widget_dic["tk_button_lhbnf1zk"].bind(
            '<Button-1>', self.handle_res_cal)
        self.widget_dic["tk_button_lhbnwwer"].bind(
            '<Button-1>', self.handle_res_import)
